...
vacancy_patterns = patterns('drama.views',
                       ...
                       url(r'^(?P<model_name>applications)/(?P<slug>[^/]*)', include(redirector_patterns), {'model': Application,'form': None,}),
...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<model_name>shows)/', include(list_patterns), {'model':Show, 'form':ShowForm, 'get_context':contexts.show}),
                       url(r'^(?P<model_name>people)/', include(list_patterns), {'model':Person, 'form':PersonForm, 'get_context':contexts.person}),
