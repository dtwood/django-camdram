...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<model_name>shows)/', include(list_patterns), {'model':Show, 'form':None, 'get_context':contexts.show}),
                       url(r'^(?P<model_name>people)/', include(list_patterns), {'model':Person, 'form':None, 'get_context':contexts.person}),
